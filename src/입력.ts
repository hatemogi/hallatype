...
function 자음([모드, 쉬프트, 키]: 키입력): number {
    return 쌍자음([모드, 쉬프트, 키]) || (모드 === 입력모드.한글 && 자음키맵.get(키)) || 0;
}

function 종성자음([모드, 쉬프트, 키]: 키입력): number {
    return 모드 === 입력모드.한글 && 초성to종성맵.get(자음([모드, 쉬프트, 키])) || 0;
}

function 모음([모드, 쉬프트, 키]: 키입력): number {
    const 코드 = 모드 === 입력모드.한글 && 모음키맵.get(키) || 0;
    if (쉬프트 && (코드 === 2 || 코드 === 6)) {
        return 코드 + 2;
    }
    return 코드;
...
function 쌍자음([모드, 쉬프트, 키]: 키입력): number {
    return 모드 === 입력모드.한글 && 쉬프트 && 쌍자음키맵.get(키) || 0;
}
